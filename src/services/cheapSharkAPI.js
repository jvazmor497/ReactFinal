//TODO Cambiar por la URL de la API de CheapShark
const cheapSharkAPI = "https://cheapshark.free.beeceptor.com";

async function getPriceData(prop) {
  ...
  "deals": [
    ...
    //         cheapSharkAPI + "/games?id=" + prop.gameID
    //     );
    //     console.log(
    //         cheapSharkAPI + "/games?id=" + prop.gameID
    //     );
...
async function getGamesList(prop) {
